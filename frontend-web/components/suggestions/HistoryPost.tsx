  ...
  return (
    <li className={cn(className.root, classes?.root)}>
      <div className={cn(className.left, classes?.left)}>
        <Link href={ROUTES.post("1")} className={cn(className.title, classes?.title)}>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod
            laborum ad eum distinctio.
          </Link>
        <Link href={ROUTES.post("1234")} className={cn(className.body, classes?.body)}>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod
            laborum ad eum distinctio.
          </Link>
        <div className={cn(className.bottom, classes?.timeBox)}>
          <time className="dark:text-neutral-dark/70 text-xs text-neutral/70">
            Jun 11
          </time>
          <Button
            type="button"
