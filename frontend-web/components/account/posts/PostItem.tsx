...
export default function PostItem({ classes }: Readonly<Props>) {
        ...
        <section className={className.actions}>
          <button
            ...
            className={cn(
              ...
              "dark:text-neutral-dark dark:hover:text-neutral-dark-focus text-neutral hover:text-neutral-focus",
            )}
            onClick={async() => {
              await push(ROUTES.user.editPost("1"));
            }}
          >
            Edit draft
          </button>
          <button
            ...
            className={cn(
              className.actionsBtn,
              "dark:text-error-dark text-error hover:text-error-focus dark:hover:text-error",
            )}
            onClick={() => {
              setAnchorEle(null);
              setOpenModel(true);
