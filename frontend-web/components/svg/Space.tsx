...
const smallStarItemVariants: Variants = {
  show: {
    scale: 1,
...
const Space = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" {...props}>
    ...
    {/* Start Big end */}
    {/* Start Small start */}
    <motion.g variants={smallStarVariants} initial="hidden" animate="show">
      <motion.g variants={smallStarItemVariants}>
        <line
          fill="none"
          className="stroke-[#0E0620] dark:stroke-base-100"
          strokeWidth="3"
    ...
    >
      ...
      <g clipPath="url(#a)">
        <motion.path
          animate={{ x: [-68, 80], rotate: -30, origin: "50%" }}
          transition={{
            repeat: Infinity,
            repeatType: "reverse",
            repeatDelay: 2,
