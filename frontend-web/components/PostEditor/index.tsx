...
import { CREATE_POST_KEY } from "@/lib/constants";
import { setLocalStorageValue, withEmbeds, withImages, withLinks } from "@/lib/utils";
...
export default function PostEditor({ onChange, value }: Readonly<Props>) {
  ...
  return (
    <section className={className.root}>
      ...
      >
        <Toolbar />
        <section className="min-h-48 overflow-x-auto px-4 py-2">
          <Editable
