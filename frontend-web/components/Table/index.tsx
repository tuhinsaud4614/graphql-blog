...
const className = {
    table:
      ...
      thead:"[&_td]:bg-base-200 [&_td]:text-sm [&_td]:font-bold [&_td]:uppercase dark:[&_td]:bg-base-dark-200 [&_th]:bg-base-200 [&_th]:text-sm [&_th]:font-bold [&_th]:uppercase dark:[&_th]:bg-base-dark-200",
      tBody:
      ...
      tfoot:"[&_td]:bg-base-200 [&_td]:text-sm [&_td]:font-bold [&_td]:uppercase dark:[&_td]:bg-base-dark-200 [&_th]:bg-base-200 [&_th]:text-sm [&_th]:font-bold [&_th]:uppercase dark:[&_th]:bg-base-dark-200",
  };
...
export default function Table<TData extends {}>({data,headers}:Props<TData>) {
