...
import { cn, countConvert, gplErrorHandler } from "@/lib/utils";
...
export default function FollowingList({ authorId }: Readonly<Props>) {
...
function SeeAll({ total, authorId }: Readonly<{ authorId: string; total: number }>) {
