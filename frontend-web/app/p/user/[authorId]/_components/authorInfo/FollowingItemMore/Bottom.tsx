...
import { countConvert } from "@/lib/utils";
...
export function Bottom({ id }: Readonly<{ id: string }>) {
  ...
  return (
    <div className={className.menuBottom}>
      ...
      <Button
        ...
        onClick={authUser?.id !== id ? onClick : undefined}
        disabled={authUser?.id === id || loadingFollow || unFollowLoading}
