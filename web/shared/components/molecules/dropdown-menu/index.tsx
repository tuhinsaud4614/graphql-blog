...
import ArrRightIcon from "../../atoms/icons/arr-right";
import CircleIcon from "../../atoms/icons/circle";
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "corner-squircle rounded-lg1 supports-squircle:rounded-[16px]",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ArrRightIcon className="ml-auto size-4" />
    </DropdownMenuPrimitive.SubTrigger>
  );
}
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 border-border z-50 min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden border p-1 shadow-lg",
        "corner-squircle rounded-lg1 supports-squircle:rounded-[20px]",
        className
      )}
      {...props}
